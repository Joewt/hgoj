 ...
 */
//c & c++
int LANG_CV[CALL_ARRAY_SIZE] = {0,1,2,3,4,5,8,9,10,11,12,13,17,20,21,59,63,89,99,158,202,231,240,272,273,275,511, SYS_time, SYS_read, SYS_uname, SYS_write, SYS_open,
